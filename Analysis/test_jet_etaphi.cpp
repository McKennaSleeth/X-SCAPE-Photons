...
int main(int argc, char* argv[]) {
  ...
  std::ofstream subtracted_jet_etaphipt_output_file("pion_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_subtracted_jet_etaphipt_output.txt", std::ios::app);
  ...
  for (const auto& filename : filenames) {
	...
	for (int i = 0; i < n_hadrons; ++i) {
	  ...
	  if (sscanf(line.c_str(), "%d %d %d %lf %lf %lf %lf", &p.id, &p.pid, &p.status, &p.E, &p.Px, &p.Py, &p.Pz) == 7) {
	    ...
	    double particle_pt = std::sqrt(p.Px * p.Px + p.Py * p.Py + p.Pz * p.Pz); // Calculate pT
	    ...
	    if (std::fabs(p.pid) == 211){
	      double pion_pt = std::sqrt(p.Px * p.Px + p.Py * p.Py + p.Pz * p.Pz); // Calculate pT
  ...
  std::ofstream particle_pt_output_file("particle_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_pt_counts.txt");
  ...
  std::ofstream pion_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_pt_counts.txt");
  ...
  std::ofstream jet_pt_diff_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_jet_pt_differences.txt");
  ...
  std::ofstream raw_jet_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_raw_jet_pt_counts.txt");
  ...
  std::ofstream raw_jet_cut_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_raw_jet_cut_pt_counts.txt");
  ...
  std::ofstream sub_jet_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_sub_jet_pt_counts.txt");
  ...
  std::ofstream sub_jet_cut_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_sub_jet_cut_pt_counts.txt");
  ...
  std::ofstream background_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_background_density_area_counts.txt");
  ...
  std::ofstream rho_particle_output_file("particle_AuAu_pTHat15_100_hard_sector_hydro_centr0_10_10k_rho_particle_counts.txt");
  ...
  std::ofstream particles_output_file("pion_pp_pTHat15_100_hard_sector_hydro_centr0_10_10k_particles_in_event_and_jets.txt");
