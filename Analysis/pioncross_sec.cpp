...
int main() {
  ...
  //fastjet::PseudoJet j1;
    ...
    std::string filename = "photon_pp_pTHat15_30_out_pi0_1M_final_state_hadrons.dat";
    const double pTlist[] = {5.0, 5.5, 6.0, 6.5, 7.0, 7.5, 8.0, 8.5, 9.0, 9.5, 10.0, 12.0, 14.0, 16.0, 18.0, 20.0}; // 16 total pT bins;
