...
int main(int argc, char* argv[]) {
		...
		for (const auto& constituent : raw_constituents) {
		  ...
		  if (std::fabs(constituent.user_index()) == 211) { // PID 22 is for photons, abs(211) is for charged pions
		    ...
		    if (delta_r <= JET_RADIUS) {
		      ...
		      total_raw_pions++;
		      double shifted_raw_pion_pt = original_pion_pt - BIN_CENTER_SHIFT;
		      int bin_index = static_cast<int>(std::floor(shifted_raw_pion_pt / PION_PT_BIN_SIZE + 0.5));
		      double binned_raw_pion_pt = BIN_CENTER_SHIFT + bin_index * PION_PT_BIN_SIZE;

		      //double binned_raw_pion_pt = std::round(original_pion_pt / PION_PT_BIN_SIZE) * PION_PT_BIN_SIZE;
		      raw_jet_pion_pt_counts[binned_raw_pion_pt]++;
  ...
  */
  ...
  /*
  std::ofstream particle_pt_output_file("particle_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_pt_counts.txt");
  ...
  */
  /*
  std::ofstream pion_pt_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_pt_counts.txt");
  ...
  */
  /*
  std::ofstream jet_pt_diff_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_jet_pt_differences.txt");
  ...
  */
  /*
  std::ofstream raw_jet_pt_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_raw_jet_pt_counts.txt");
  ...
  */
  /*
  std::ofstream raw_jet_cut_pt_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_raw_jet_cut_pt_counts.txt");
  ...
  */
  /*
  std::ofstream sub_jet_pt_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_sub_jet_pt_counts.txt");
  ...
  */
  /*
  std::ofstream sub_jet_cut_pt_output_file("pion_JETSCAPE_AuAu_pTHat15_100_hard_sector_hydro100_centr0_10_notrackpTcut_1k_sub_jet_cut_pt_counts.txt");
  ...
  */
  /*
  std::ofstream background_output_file("pion_JETSCAPE_pp_pTHat15_100_nohydro_10M_notrackpTcut_background_density_area_counts.txt");
  ...
  */
  /*
  std::ofstream rho_particle_output_file("particle_pp_pTHat15_100_nohydro_10M_notrackpTcut_rho_particle_counts.txt");
  ...
  */
  /*
  std::ofstream particles_output_file("pion_pp_pTHat15_100_hard_sector_hydro10_centr0_10_10k_notrackpTcut_particles_in_event_and_jets.txt");
